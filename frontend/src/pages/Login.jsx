...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('http://localhost:5001/auth/user/login', { email, password },{withCredentials:true});
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      ...
      >
        <div className="w-96 p-6 shadow-lg bg-gray-800 text-white rounded-2xl">
          <div className="text-center text-2xl font-semibold mb-4">Welcome Back</div>
